...
public  class PageControl extends ViewGroup {
    ...
    /**
     * called after swipe or setPage
     */
    private OnPageChangeListener pageChangeListener;
    /**
     * called only with sipe
     */
    private OnPageSwipeListener swipeListener;
    protected OnPageClickListener onClickListener;
    ...
    /**
     * if the user did a swipe
     */
    private boolean modeSwipe;
...
//            }
            ...
            if (mFirstLayout) {
                ...
                mNextScreen = Math.max(0, Math.min(getPage(), getChildCount() - 1));
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING) {
                    ...
                    if (velocityX > mDensityAdjustedSnapVelocity && mCurrentPage > 0) {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (swipeListener != null && modeSwipe) {
                modeSwipe = false;
                swipeListener.onPageSwipe(mCurrentPage);
            }
            if (pageChangeListener != null) {
                pageChangeListener.onPageChanged(mCurrentPage);
            }
    ...
    public View getPageView() {
        return getChildAt(mCurrentPage);
    }
     ...
     */
    public boolean setPage(final int currentScreen, final boolean animate) {
        return setPage(currentScreen, animate, false);
    }
     ...
     * @param animate True to smoothly scroll to the screen, false to snap instantly
     */
    public boolean setPage(final int currentScreen, final boolean animate, boolean force) {
        if(mCurrentPage == currentScreen && !force) {
            return false;
        }
     ...
     * @param listener
     */
    public void setOnSwipeListener(final OnPageSwipeListener listener) {
    ...
    public static interface OnPageChangeListener {
         ...
         *
         * @param page The new screen index.
         */
     ...
     * Listener for the event that the HorizontalPager switches to a new view.
     */
    public static interface OnPageSwipeListener {
        /**
         * Notifies listeners about the new screen. Runs after the animation completed.
         *
         * @param page The new screen index.
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    if(onClickListener != null) {
                        onClickListener.onPageClicked(page);
                    }
                }
            });
            addView(view);
    ...
    public void setOnPageChanged(int page) {
        if (pageChangeListener != null) {
