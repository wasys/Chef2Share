...
public class IntentUtils {
	...
	public static boolean isIntentAvailable(Context context, String action) {
	    try {
			...
			Log.e(TAG, ExceptionUtils.getMessage("isIntentAvailable", e));
			return false;
		}
	}
	
	/**
	 * Instala o APK que est� no sdcard no celular
	 * 
	 * @param context
	 * @param sdcardFile
	 * @param requestCode
	 */
	public static  void installApk(Activity context, File sdcardFile, int requestCode ) {
		Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setDataAndType(Uri.fromFile(sdcardFile),"application/vnd.android.package-archive");
	...
	/**
	 * Metodo que verifica se existe o pacote instalado
	 * 
	 * @param context
	 * @param pacote
	 * @return
