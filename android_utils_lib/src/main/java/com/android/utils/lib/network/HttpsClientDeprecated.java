 ...
 */
@Deprecated
public class HttpsClientDeprecated extends DefaultHttpClient {

	final Context context;
	final int rawCertificado;
	final String senhaCertificado;

	public HttpsClientDeprecated(Context context, String senhaCertificado, int rawCertificado) {
	...
	protected ClientConnectionManager createClientConnectionManager() {
		try {
			...
			final ThreadSafeClientConnManager cm = new ThreadSafeClientConnManager(getParams(), schemeRegistry);
			return cm;
	...
	protected org.apache.http.conn.ssl.SSLSocketFactory createAdditionalCertsSSLSocketFactory() {
	    try {
	        ...
	        final InputStream in = context.getResources().openRawResource(rawCertificado);  
	        try {
	            // don't forget to put the password used above in strings.xml/mystore_password
	            ks.load(in, senhaCertificado.toCharArray());
	        } finally {
	            in.close();
	        }
