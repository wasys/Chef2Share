 ...
 * 
 * This class provides encoding/decoding methods for the Base64 encoding as defined by RFC 2045
 *
...
public final class Base64 {
	...
	public static boolean isBase64(String isValidString) {
		return isArrayByteBase64(ASCII.getAsciiBytes(isValidString));
	}
